...
namespace SofaScore.Api.Migrations
{
    ...
    [Migration("20260203032133_AddStandings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbIncident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbMatch", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbMatchStat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbRoundState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbStanding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TournamentId", "SeasonId", "Position");

                    b.HasIndex("TournamentId", "SeasonId", "TeamId")
                        .IsUnique();

                    b.ToTable("Standings");
                });

            modelBuilder.Entity("SofaScore.Shared.Data.DbStandingPromotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StandingPromotions");
                });

            modelBuilder.Entity("SofaScore.Shared.Data.DbIncident", b =>
                {
                    b.HasOne("SofaScore.Shared.Data.DbMatch", "Match")
                        .WithMany("Incidents")
            ...
            modelBuilder.Entity("SofaScore.Shared.Data.DbStandingPromotion", b =>
                {
                    b.HasOne("SofaScore.Shared.Data.DbStanding", "Standing")
                        .WithMany("Promotions")
